...
#
get_filename_component(filename "/home/xrenne/dotfiles/.local/share/clone/neovim/.deps/build/downloads/lua_compat53/v0.13.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/xrenne/dotfiles/.local/share/clone/neovim/.deps/build/src/lua_compat53" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-lua_compat53${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-lua_compat53${i}")
