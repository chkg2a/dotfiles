...
#
get_filename_component(filename "/home/xrenne/dotfiles/.local/share/clone/neovim/.deps/build/downloads/treesitter_lua/v0.3.0.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/xrenne/dotfiles/.local/share/clone/neovim/.deps/build/src/treesitter_lua" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-treesitter_lua${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-treesitter_lua${i}")
